...
inline const ParamDef kParams[] = {
    ...
    { FVP_PITCH_RATE,    "pitchScale",  L"Pitch &scale",
    ...
    { FVP_PITCH_MAX,     "pitchCeil",   L"Pitch &ceiling",
    ...
    { FVP_HEADSIZE,      "headSize",    L"&Head size",
